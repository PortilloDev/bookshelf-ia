...
@section('title', __('app.auth.login.title') . ' - ' . __('app.name'))
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input id="email" 
                           ...
                           placeholder="{{ __('app.auth.login.email_placeholder') }}">
                    @error('email')
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-background text-muted-foreground">{{ __('app.auth.login.continue_with_email') }}</span>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <a href="{{ route('google.redirect') }}" 
                       class="w-full inline-flex justify-center py-2 px-4 border border-input rounded-md shadow-sm bg-background text-sm font-medium text-foreground hover:bg-accent hover:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                        ...
                        {{ __('app.auth.login.continue_with_google') }}
                    </a>
                </div>
            </div>
            ...
            <div class="text-center">
                <p class="text-sm text-muted-foreground">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-primary hover:text-primary/80">
                        {{ __('app.auth.login.register_here') }}
                    </a>
                </p>
            </div>
        </form>
